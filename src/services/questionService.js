...
const ANALOGY_TEMPLATES = [
	{
		...
		hint: 'What do you wear right in front of your eyes to see better?',
	},
	{
		item1: 'Foot 🦶',
		rel1: 'Shoe 👟',
	...
	},
	{
		...
		item2: 'Deer 🦌',
		correct: 'Fawn',
		distractors: ['Puppy 🐶', 'Cub 🐻', 'Chick 🐥'],
		hint: 'What is a cute baby deer called?',
	},
	{
		item1: 'Cow 🐄',
		rel1: 'Calf',
		item2: 'Sheep 🐑',
		correct: 'Lamb',
		distractors: ['Foal 🐴', 'Piglet 🐷', 'Kitten 🐱'],
		hint: 'What do we call a fluffy baby sheep?',
	},
	{
		item1: 'Doctor 🩺',
		rel1: 'Hospital 🏥',
	...
	},
	{
		...
		item2: 'Ship 🚢',
		correct: 'Ocean Water 🌊',
		distractors: ['Highway 🛣️', 'Sky ☁️', 'Grass 🌿'],
		hint: 'Where does a big ship sail?',
	},
	{
		item1: 'Dog 🐕',
		rel1: 'Bark 🐶',
	...
	},
	{
		...
		item2: 'Light 🪶',
		correct: 'Feather 🪶',
		distractors: ['Anvil ⚓', 'Rock 🪨', 'Bigger Truck 🚛'],
		hint: 'What is very lightweight and floats in the breeze?',
	},
	{
		item1: 'Cold 🧊',
		rel1: 'Ice Cream 🍦',
		item2: 'Hot 🔥',
		correct: 'Warm Soup 🍲',
		distractors: ['Ice Cube 🧊', 'Snow ❄️', 'Cold Milk 🥛'],
		hint: 'Which food is served warm and steamy for dinner?',
	},
	{
		item1: 'Bed 🛏️',
		rel1: 'Sleep 😴',
		item2: 'Chair 🪑',
		correct: 'Sit 🪑',
		distractors: ['Swim 🏊', 'Fly ✈️', 'Run 🏃'],
		hint: 'What do you do when you use a chair?',
	},
	{
		item1: 'Book 📖',
		rel1: 'Read 👓',
		item2: 'Song 🎵',
		correct: 'Listen / Sing 🎤',
		distractors: ['Bake 🍞', 'Sleep 💤', 'Draw ✏️'],
		hint: 'What do we do when happy music is playing?',
	},
	{
		item1: 'Rain 🌧️',
		rel1: 'Umbrella ☔',
		item2: 'Bright Sun ☀️',
		correct: 'Sunglasses 🕶️',
		distractors: ['Raincoat 🧥', 'Snowboots 🥾', 'Blanket 🛋️'],
		hint: 'What protects our eyes from bright sunny rays?',
	},
	{
		item1: 'Morning 🌅',
		rel1: 'Breakfast 🥞',
		item2: 'Night 🌙',
		correct: 'Dinner / Supper 🍲',
		distractors: ['Lunch 🥪', 'Sunrise ☀️', 'Snack 🍎'],
		hint: 'What meal do we eat in the evening before sleeping?',
	},
	{
		item1: 'Horse 🐎',
		rel1: 'Barn 🚜',
		item2: 'Lion 🦁',
		correct: 'Den / Savanna 🌿',
		distractors: ['Birdcage 🪹', 'Fishbowl 🐠', 'Kitchen 🍳'],
		hint: 'Where does a wild lion live with its pride?',
	},
	{
		item1: 'Tree 🌳',
		rel1: 'Leaves 🍃',
		item2: 'Flower 🌸',
		correct: 'Petals 🌺',
		distractors: ['Bark 🪵', 'Roots 🌱', 'Branches 🌿'],
		hint: 'What colorful parts make up a blossoming flower?',
	},
];
...
const ODD_ONE_OUT_TEMPLATES = [
	{
		question: 'Which one does NOT fly up in the sky?',
		correct: 'Goldfish 🐟',
		distractors: ['Eagle 🦅', 'Butterfly 🦋', 'Airplane ✈️'],
		hint: 'Three of these can fly high. Which one lives underwater in a fish tank?',
	},
	{
		question: 'Which one does NOT live or swim in water?',
		correct: 'Lion 🦁',
		distractors: ['Dolphin 🐬', 'Shark 🦈', 'Jellyfish 🪼'],
		hint: 'Which animal lives on dry grassy land?',
	},
	{
		question: 'Which one is NOT a vehicle with rolling wheels?',
		correct: 'Oak Tree 🌳',
		distractors: ['Bicycle 🚲', 'School Bus 🚌', 'Motorcycle 🏍️'],
		hint: 'Which one is a plant that grows roots in dirt?',
	},
	{
		question: 'Which one is NOT worn in cold winter weather?',
		correct: 'Swimsuit 🩱',
		distractors: ['Warm Beanie Hat 🧢', 'Wool Mittens 🧤', 'Cozy Scarf 🧣'],
		hint: 'What outfit do you wear at the pool during hot summer days?',
	},
	{
		question: 'Which one is NOT a musical instrument you can play?',
		correct: 'Hammer 🔨',
		distractors: ['Acoustic Guitar 🎸', 'Snare Drum 🥁', 'Piano Keys 🎹'],
		hint: 'Which tool is used for pounding nails in wood, not making music?',
	},
	{
		question: 'Which one is NOT an animal with four legs?',
		correct: 'Yellow Duck 🦆',
		distractors: ['Friendly Dog 🐕', 'Horse 🐎', 'Elephant 🐘'],
		hint: 'Which creature walks on 2 webbed feet and has wings?',
	},
	{
		question: 'Which one is NOT naturally yellow in color?',
		correct: 'Red Strawberry 🍓',
		distractors: ['Ripe Banana 🍌', 'Fresh Lemon 🍋', 'Sunflower 🌻'],
		hint: 'Which sweet berry is bright red with little seeds?',
	},
	{
		question: 'Which one does NOT belong in the kitchen cooking food?',
		correct: 'Toothbrush 🪥',
		distractors: ['Frying Pan 🍳', 'Soup Spoon 🥄', 'Eating Plate 🍽️'],
		hint: 'Which item is kept in the bathroom for brushing teeth?',
	},
	{
		question: 'Which one is NOT a sweet fruit you can eat?',
		correct: 'Toy Robot 🤖',
		distractors: ['Red Apple 🍎', 'Juicy Orange 🍊', 'Sweet Grape 🍇'],
		hint: 'Which one is a toy made of metal and plastic?',
	},
	{
		question: 'Which one is NOT a shape with straight edges?',
		correct: 'Round Circle ⭕',
		distractors: ['Square ⬛', 'Triangle 🔺', 'Rectangle ▬'],
		hint: 'Which shape is completely curved with no sharp corners?',
	},
];
...
const CAUSE_EFFECT_TEMPLATES = [
	{
		question: 'If you water a tiny seed in nutrient soil 🌱, what will happen?',
		correct: 'It sprouts into a green plant 🌿',
		distractors: [
			'It turns into ice 🧊',
			'It disappears forever ❌',
			'It turns into a rock 🪨',
		],
		hint: 'What happens when seeds get sunlight and water?',
	},
	{
		question:
			'If you blow air into an empty rubber balloon 🎈, what will happen?',
		correct: 'It grows bigger and expands 🎈',
		distractors: [
			'It gets smaller 🤏',
			'It turns into glass 🪟',
			'It catches fire 🔥',
		],
		hint: 'Think about birthday balloons when pumped with air.',
	},
	{
		question:
			'What happens when you flip ON the light switch in a dark room 💡?',
		correct: 'The room becomes bright and visible 💡',
		distractors: [
			'It starts raining inside 🌧️',
			'The room gets colder ❄️',
			'The door locks 🔒',
		],
		hint: 'What does an electric light bulb do when turned on?',
	},
	{
		question: 'Which lightweight object will FLOAT on top of bath water 🛁?',
		correct: 'Hollow Rubber Duck 🦆',
		distractors: ['Heavy Iron Key 🔑', 'Solid Rock Stone 🪨', 'Metal Spoon 🥄'],
		hint: 'Which toy stays right on top of bathwater without sinking?',
	},
	{
		question:
			'What happens if you leave a bowl of vanilla ice cream 🍨 in the warm sun ☀️?',
		correct: 'It melts into sweet liquid 🍦',
		distractors: [
			'It freezes harder 🧊',
			'It turns into bread 🍞',
			'It flies away 🕊️',
		],
		hint: 'What happens to ice cream when it gets warm?',
	},
];
...
async function fetchFromInternetAPI(count = 5) {
	try {
		const res = await fetch(
			`https://opentdb.com/api.php?amount=${count}&category=17&difficulty=easy&type=multiple`,
		);
		if (!res.ok) return [];
		...
		console.warn(
			'Internet fetch offline or rate-limited; procedural engine activated',
			err,
		);
		return [];
	}
...
function generateInfiniteVisualQuestion(seenSignatures) {
	...
	for (let attempt = 0; attempt < 30; attempt++) {
		...
		if (kind === 'grid-tiles') {
			...
			if (!seenSignatures.has(signature) || attempt > 25) {
				...
				return {
					...
					promptAudio:
						'How many more tiles will be needed to fill in the empty area?',
		...
		if (kind === 'scale-balance') {
			...
			const pair =
				balancePairs[Math.floor(Math.random() * balancePairs.length)];
			...
			if (!seenSignatures.has(signature) || attempt > 25) {
				...
				return {
					...
					categoryDescription: CATEGORY_DESCRIPTIONS['Visual'],
					question:
						'Which object is heavier according to the seesaw balance diagram?',
					promptAudio:
						'Which object is heavier according to the seesaw balance diagram?',
		...
		if (kind === 'paper-cut') {
			...
			return {
				...
				categoryDescription: CATEGORY_DESCRIPTIONS['Visual'],
				question:
					'The paper sheet is cut along the dotted line. How many corners will the resulting shape on the right have?',
				promptAudio:
					'How many corners will the resulting paper sheet on the right have?',
				diagramType: 'paper-cut',
				options,
				correctAnswerId,
				solutionText:
					'The cut paper sheet on the right forms a rectangle with 4 corners.',
		...
		if (kind === 'butterfly-symmetry') {
			...
			seenSignatures.add(signature);
			const { options, correctAnswerId } = buildOptions('Right Wing 🦋', [
				'Left Wing',
				'Star Wing ⭐',
				'Circle Wing ⭕',
			]);
			...
			return {
				...
				categoryDescription: CATEGORY_DESCRIPTIONS['Visual'],
				question:
					'Which wing completes the colorful butterfly with mirror symmetry 🦋?',
				promptAudio:
					'Which wing completes the colorful butterfly with mirror symmetry?',
				...
				correctAnswerId,
				solutionText:
					'Butterflies have mirror symmetry! The matching right wing mirrors the left wing.',
		...
		if (kind === 'rocket-maze') {
			...
			seenSignatures.add(signature);
			const { options, correctAnswerId } = buildOptions('Path B ⭐', [
				'Path A 🪐',
				'Path C 🛸',
				'Path D ☄️',
			]);
			...
			return {
				...
				correctAnswerId,
				solutionText:
					'Path B (blue dashed line) curves directly to the golden star!',
...
function generateInfiniteAnalyticalQuestion(seenSignatures) {
	...
	let candidates = allPool.filter(
		(item) => !seenSignatures.has(item.signature),
	);
